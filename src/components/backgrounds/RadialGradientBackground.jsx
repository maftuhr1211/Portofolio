...
const RadialGradientBackground = ({ variant = 'hero', gradients = [] }) => {
  ...
  hero: [
    {
      ...
      colors: [
        { color: 'rgba(96, 165, 250, 0.25)', stop: '100%' },
        { color: 'rgba(59, 130, 246, 0.45)', stop: '100%' },
        { color: 'rgba(37, 99, 235, 0.50)', stop: '100%' },
        { color: 'rgba(59, 130, 246, 0.45)', stop: '100%' },
        { color: 'rgba(96, 165, 250, 0.25)', stop: '100%' },
      ],
      blur: '8px',
  ...
  const generateGradient = (colors) => {
    const colorStops = colors
      ...
      .join(', ')
    return `radial-gradient(circle at center, transparent 0%, transparent 30%, ${colorStops}, transparent 60%, transparent 5%)`;
  };
