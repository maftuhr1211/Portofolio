...
import { Mail, Linkedin, Instagram, MessageSquare, Send, MapPin, Heart } from 'lucide-react';
                ...
                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                  ...
                  return (
                    <a
                      ...
                      className="group relative p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-primary/50 hover:scale-105 transition-all duration-300"
